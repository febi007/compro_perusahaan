(function () {
    ...
    jQuery("#rev_slider_29_1").show().revolution({
        sliderType:"standard",
jsFileLocation:"//localhost/revslider-standalone/revslider/public/dev/assets/js/",
        sliderLayout:"fullwidth",
        dottedOverlay:"none",
        delay:9000,
        navigation: {
    ...
    jQuery("#rev_slider_6_1").show().revolution({
        ...
        sliderType: "standard",
        jsFileLocation: "//localhost/rev/revslider-standalone/revslider/public/dev/assets/js/",
        sliderLayout: "fullscreen",
        dottedOverlay: "none",
        delay: 9000,
        navigation: {
