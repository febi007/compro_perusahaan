<div class="row">
    <div class="col-md-3">
        <ul class="list-group">
            ...
            <li class="list-group-item" data-id='6' style="cursor:pointer" id="mvm" onClick='event.preventDefault();changeShow(this);'>About</li>
            <li class="list-group-item" data-id='6' style="cursor:pointer" id="svc" onClick='event.preventDefault();changeShow(this);'>Service</li>
