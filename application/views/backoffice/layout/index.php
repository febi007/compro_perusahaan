...
<!--[if lt IE 9]>
<script src="dev/assets/script/html5shiv.min.js"></script>
<script src="dev/assets/script/respond.min.js"></script>
<![endif]-->
<!--
================================================== -->
	...
	function set_ckeditor(id){
		$(function () {
			var editor =CKEDITOR.replace(id, {
				filebrowserImageBrowseUrl : '<?php echo base_url('dev/assets/bo/plugin/kcfinder/browse.php?type=upload');?>',
				height: '300px'
			});
