		...
		<div class="col-md-6 col-lg-6">
			<article class="blog-post standard-post">
				...
				<div class="thumbnail mb--60">
					<img class="w-100" src="<?=base_url('/').$detail['image']?>" alt="" onerror="this.onerror=null;this.src='<?=base_url('dev/assets/img/default-img.jpg');?>';" >
				</div>
			</article>
		</div>
		<div class="col-md-6 col-lg-6">
			<article class="blog-post standard-post">
				...
				<div class="header mb--40 text-center">
					<h3 class="heading heading-h3 font-32"><?=$detail['title']?></h3>
				...
				<div class="content basic-dark2-line-1px pb--50 mb--35">
					<div class="inner"><?=$detail['deskripsi']?></div>
					</div>
				</div>
			</article>
		</div>
