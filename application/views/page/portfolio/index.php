...
<!-- <div class="brook-what-do-area bg_color--1 jarak"> -->
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="brook-section-title text-center mb--60">
                                <h3 class="heading heading-h3">Portfolio</h3>
                    ...
                    <div class="row">
						...
						<div class="messonry-button mb--70">
								<button data-filter="*" class="is-checked"><span class="filter-text">All</span><span class="filter-counter"><?=count($portfolio)?></span></button>
								
								<?php foreach($portfoliosCat as $row){ ?>
									<br><button data-filter=".cat--<?=$row['id']?>"><span class="filter-text"><?=$row['nama']?></span></button>
								<?php } ?>
                        ...
                        <div class="col-lg-12">
                            <div class="portfolio-grid-metro6 mesonry-list">
                                ...
                                <div class="portfolio-33-33 cat--<?=$row['id_product']?>">
                                    <div class="portfolio with-caption">
                                        <div class="thumb video-with-thumb">
                                            <a href="<?=base_url('portfolio/detail/').$row['slug'];?>">
                                                <img src="<?=$row['image']?>" alt="portfolio images" onerror="this.onerror=null;this.src='<?=base_url('dev/assets/img/default-img.jpg');?>';" >
                                            </a>
                                        </div>
                                        <div class="caption-bottom text-center">
                                            <div class="info">
                                                <h5 class="heading heading-h5"><a href="<?=base_url('portfolio/detail/').$row['slug'];?>"><?=$row['title']?></a></h5>
                                                <!-- <p class="bk_pra"><?=$row['deskripsi']?></p> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
