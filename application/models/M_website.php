        ...
        return /** @lang text */
            ...
            <div class="col-lg-6">
                <div class="team-details__content">
                    ...
                    <p class="team-details__text" style="text-align:justify">'.strip_tags($desc).'</p>v
                </div>
            </div>
        ';
    }
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        ...
                        <p class="team-one__designation">NIP : '.$nip.'</p>
                        <p class="team-one__text" style="text-align:justify" id="short'.$nip.'">'.strip_tags($potong).'</p>
                        <p class="team-one__text" style="text-align:justify;display:none" id="long'.$nip.'" >'.strip_tags($desc).'</p>
                        <a href="#" id="toggleMore" onClick="event.preventDefault();toggleDesc(this, \''.$nip.'\')" data-id="1" class="link">read more</a>
                    </div>
                </div>
            </div>
        ';
                ...
                <div class="course-one__single">
                    ...
                    <div class="course-one__content">
                        ...
                        <div class="course-one__admin">
                            <img src="dev/assets/images/team-1-1.jpg" alt="">
                            by <a href="#">'.$name.'</a>
