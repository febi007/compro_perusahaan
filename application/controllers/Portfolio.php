...
class Portfolio extends CI_Controller
{
    public function index(){
		$data['isi'] = 'page/portfolio/index';
		
        $data['portfolio'] = $this->M_crud->read_data("tbl_portfolio","*",null,"id desc",null);
		$data['portfoliosCat'] = $this->M_crud->read_data("tbl_product","id, nama",null,"id desc",null);
	...
	public function detail($slug){
		if (!isset($slug)){
			...
			$data['isi'] = 'page/portfolio/detail_portfolio';
			$data['detail'] = $this->M_crud->get_data("tbl_portfolio","*","status='1' and slug='".$slug."'");
			$this->load->view("layout/wrapper.php",$data);
		}
	}
